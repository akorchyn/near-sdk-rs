...
use syn::{Expr, ImplItem, ItemEnum, ItemImpl, ItemStruct, ItemTrait, WhereClause, parse_quote};
        ...
        let json_impl = if json_schema {
            ...
            quote! {
                ...
                impl #generics #near_sdk_crate::schemars::JsonSchema for #input_ident_proxy #generics #where_clause {
                    ...
                    fn json_schema(generator: &mut #near_sdk_crate::schemars::r#gen::SchemaGenerator) -> #near_sdk_crate::schemars::schema::Schema {
                        <#input_ident #generics as #near_sdk_crate::schemars::JsonSchema>::json_schema(generator)
                    }
                }
            }
        } else {
